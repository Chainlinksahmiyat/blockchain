...
exports.scanFileForVirus = scanFileForVirus;
...
function validateFileType(filePath) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    parser = new file_type_1.FileTypeParser();
                    return [4 /*yield*/, parser.fromFile(filePath)];
                case 1:
                    type = _a.sent();
                    return [2 /*return*/, type ? exports.allowedMimeTypes.includes(type.mime) : false];
            }
        });
    });
}
...
function scanFileForVirus(filePath) {
    return new Promise(function (resolve, reject) {
        (0, child_process_1.exec)("clamscan --no-summary ".concat(filePath), function (err, stdout) {
            if (err)
                return reject(err);
